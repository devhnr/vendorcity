...
class Homecontroller extends Controller
{
    public function index(){
     ...
     // $data['service']=DB::table('services')->orderBy('set_order')->get();
        ...
        $data['meta_title'] = "Discover Top Home Services in the UAE: Get Up to 5 Free Quotes at VendorsCity";
...
//echo "<pre>";print_r($data);echo "</pre>";exit;
    ...
    public function subservices($service_url=''){
        ...
        $data['meta_title'] = $data['service_data']->meta_title;
        $data['meta_keyword'] = $data['service_data']->meta_keyword;
        $data['meta_description'] = $data['service_data']->meta_description;
