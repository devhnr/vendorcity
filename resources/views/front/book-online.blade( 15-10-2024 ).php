                ...
                <div class="tab1">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw500 dark-color"
                            for="country">What type of painting service do you need?</label>
                        <select class="form-control searches_drop"
                            id="formfield_value_test"
                            name="formfield_value"
                            onchange="paintingServices(this.value)">
                            <option value="">Select What type of painting service do you need?
                            </option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group size-of-home-tab1" style="display: inline-flex;">
                            <div class="hour_input">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group need_cleaner" style="display: inline-flex;">
                            ...
                            <div class="hour_input">
                                <input type="radio" id="color-are-you-walls-now-4" name="what_color_your_walls_now" value="Mixied">
                                <label for="color-are-you-walls-now-4">Mixied</label>
                                <p style="font-size: 9px; margin-left:15px;"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group need_cleaner" style="display: inline-flex;">
                            ...
                            <div class="hour_input">
                                <input type="radio" id="is-your-home-furnished-1" name="isYourHomeFurnshed" value="Yes" checked>
                                <label for="is-your-home-furnished-1">Yes</label>
                                <p style="font-size: 9px; margin-left:14px;"></p>
                            </div>
                    
                            <div class="hour_input">
                                <input type="radio" id="is-your-home-furnished-2" name="isYourHomeFurnshed" value="No">
