                                    ...
                                    <div class="subservice_image_sec">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="listing-style1 bdrs12">
                                                ...
                                                @php
                                                $selectedCityId = session('search_city_id');
                                                $selectedCityName = $city->firstWhere('id', $selectedCityId)->name ?? 'No City Selected';
                                            @endphp

                                                <div class="list-content">
                                                    <a class="d-flex align-items-center" 
                                                        href="{{ url('package-lists/' . $subservice->page_url) }}">
                                                        {{ $subservice->subservicename }}@if($selectedCityId) in {{ $selectedCityName }} @endif</a>
                                                </div>
