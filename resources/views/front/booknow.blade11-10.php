        ...
        <div class="col-lg-6">
                ...
                <div class="tab1">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw500 dark-color " for="country">How many hours do you need your cleaner to stay? 
                            @if($subservice_id == 28)
                            <span style="margin-right: auto;text-align: center;background: #ffda40;padding: 2px 9px 2px 0px;color: #000;margin-left: 5px;border-radius: 50%;font-weight: 1000;font-size: 14px;"> 
                                <a style="cursor: pointer;" data-bs-toggle="modal" id="cleaner_stay" data-bs-target="#Learnmore_{{$subservice_id}}">
                                <i class="fa-solid fa-info" style="margin-left: 10px;"></i>
                                </span>
                           <span id="learn_more"> Learn more</a></span>@endif
                        </label>
                        ...
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:14px;">AED {{$cleaning_price[0]->hourly_price}}/hr</p>
                        </div>
                        ...
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[1]->hourly_price}}/hr</p>
                        </div>

                        <div class="hour_input" style="position: relative;">
                            <span>Popular</span>
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[2]->hourly_price}}/hr</p>
                        </div>
                        ...
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[3]->hourly_price}}/hr</p>
                        </div>
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[4]->hourly_price}}/hr</p>
                        </div>
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[5]->hourly_price}}/hr</p>
                        </div>
                        <div class="hour_input">
                            ...
                            <p style="font-size: 9px; margin-left:15px;">AED {{$cleaning_price[6]->hourly_price}}/hr</p>
                        </div>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group hour_input">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw500 dark-color " for="country">Need cleaning materials? </label>|
                        <img src="{{ asset('public/site/images/dettol.png') }}" style="height: 25px;">
                       <p class="dettol">Powered by Dettol</p>
                       @if($subservice_id == 28)
                            <span style="margin-right: auto;text-align: center;background: #ffda40;padding:3px 6px 2px 0px;;color: #000;margin-left: 5px;border-radius: 50%;font-weight: 1000;font-size: 14px;"> 
                                <a style="cursor: pointer;" data-bs-toggle="modal" id="cleaner_stay" data-bs-target="#material_{{$subservice_id}}">
                                <i class="fa-solid fa-info" style="margin-left: 10px;"></i>
                                </span> <span>Learn more</a></span>@endif
                        <p style="margin-top: -10px;font-size:13px;">An additional charge of AED 10/hr applies.</p>
            ...
            <button id="stickyButton" class="booking-summary">
                <div class="d-flex justify-content-between">
                <div class="font-weight-bold" style="text-align: right;">
                    <stong>AED<span id="frequency_summary_cross_amount_mobile" style="text-decoration: line-through;"></span></stong>
                    <span id="total_to_pay_charge_replace_mobile"></span></div>
                    <i style="margin-left:5px;" class="fa-solid fa-angle-up" id="aerrowicon"></i>
            </div>
            <p id="selected_weekly" style="font-size: 17px; font-weight:1000;color: #fff;
            margin-right: 34px;" ></p>
            </button>
    ...
    <div id="modal-digi" class="modal-dialog" role="document" style="">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="border-radius: 50%; width: 35px; height: 35px; background-color: #707070; font-size: 38px; color: #fff; border: none;">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div>
    ...
    <div id="modal-digi" class="modal-dialog" role="document" style="overflow: auto;">
        <div class="modal-content">
            <div class="modal-header" style="display:block;"> 
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="border-radius: 50%; width: 35px; height: 35px; background-color: #707070; font-size: 38px; color: #fff; border: none;float: right;}">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
