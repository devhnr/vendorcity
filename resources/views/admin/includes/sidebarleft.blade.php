    ...
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
            ...
            @endif
                ...
                @if (in_array('19', $permission1))
                    <li class="{{ request()->segment(2) == 'order' ? 'active' : '' }}">
                        <a href="{{ route('order.index') }}"><i data-feather="clipboard"></i><span>Package Order - Moving</span></a>
                    </li>
                    <li class="{{ request()->segment(1) == 'cleaning_package_order' ? 'active' : '' }}">
                         <a href="{{ route('cleaning_package_order') }}">
                            <i data-feather="clipboard"></i>
                            <span>Package Order - Cleaning</span>
                        </a>
                    </li>
                @endif
