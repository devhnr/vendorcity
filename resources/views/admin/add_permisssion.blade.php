            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('user_permission.index') }}">Permission</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('user_permission.store') }}" method="POST"
                   ...
                   <button type="submit" class="btn btn-danger" style="line-height: 16px;">Delete</button>
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a class="btn btn-primary" href="{{ route('user_permission.index') }}"> Cancel</a>
