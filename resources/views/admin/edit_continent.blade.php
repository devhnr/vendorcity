...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit Continent</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('continent.index') }}">Continent</a></li>
                        <li class="breadcrumb-item active">Edit Continent</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('continent.update', $continent->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input id="continent" name="continent" type="text" class="form-control"
                                        placeholder="Enter Continent" value="{{ $continent->continent }}" />
