                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-center table-hover datatable" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($orders->items) && isset($orders->items[0]))
                                            <tr>
                                                ...
                                                <!-- <td>{{$orders->items[0]->service_name}}</td> -->
 
                                                  <td>{!! Helper::servicename($orders->items[0]->service_id) !!}</td>

                                                  <!-- <td>{{$orders->items[0]->subservice_name}}</td> -->

                                                <td>{!! Helper::subservicename($orders->items[0]->subservice_id) !!}</td>
