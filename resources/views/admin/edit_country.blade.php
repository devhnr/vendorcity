            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('country.update', $country->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                   ...
                                   <select class="form-control" id="continent" name="continent_id">
                                       ...
                                       @foreach ($continent_data as $continent)
                                           <option value="{{ $continent->id }}" {{ $continent->id == $country->continent_id ? "selected" : "" }}>{{ $continent->continent }}</option>
                                       @endforeach
                                   </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="country" name="country" type="text" class="form-control"
                                        placeholder="Enter Country" value="{{ $country->country }}" />
                                    <p class="form-error-text" id="country_error" style="color: red; margin-top: 10px;"></p>
                                </div>
                            </div>
                            <div class="text-end mt-4">
                                <a class="btn btn-primary" href="{{ route('country.index') }}"> Cancel</a>
...
@section('footer_js')
    <script>
        function category_validation() {
            ...
            if (continent == '') {
                jQuery('#continent_error').html("Please Select Continent");
