            ...
            <div class="col-lg-6">
                ...
                <div class="tab3" style="display:none">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group">
                            <input type="radio" id="time1" name="time_slot" value="8:00 AM - 8:30 AM" >
                            <label for="time1">8:00 AM - 8:30 AM</label>
...
@php 
   ...
   function calculation_book_now(){
    ...
    //alert('{{ $subtotal }}');
        ...
        var sub_total = parseInt('{{ $subtotal }}') + parseInt(additional_charge);
    ...
    function get_hide_show(id){
        ...
        if(id == 5){
            ...
            $('#frequency_summary_timeslot').html(time_slotSelected.value);
            ...
            var sub_total = parseInt(service_charge) + parseInt(additional_charge) + parseInt(cod_charge) + parseInt(service_fee) ;
