        ...
        <div class="page-header">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="page-title">Bulk State Upload</h3>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Bulk State Upload</li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('upload_state') }}" method="POST"
