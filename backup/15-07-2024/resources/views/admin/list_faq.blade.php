    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                @if (in_array('23', $edit_perm))
                    <div class="col-auto">



                        <a class="btn btn-primary me-1" href="{{ route('faq.create') }}">
            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_faq') }}" enctype="multipart/form-data">
