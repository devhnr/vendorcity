     ...
     <body style="margin: 0;font-family: Arial, Helvetica, sans-serif;">
         ...
         <div style="max-width:630px;margin: 0 auto;border: thin solid #f3f0f0;">
             ...
             <header style="text-align:center;"><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
                 ...
                 <a href="{{ config("app.url") }}"><img style="max-width:100px;display: inline-block;" src="'.asset("public/site/images/VC-FULL-COLOR.png").'"></a>           </header>
             ...
             <div style="background:#EDEDED;padding: 20px 7%;font-size: 14px;text-align: left;">
                 ...
                 <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;line-height: 30px;color:#fff;margin:0; color:black">
                         ...
                         <strong> Confirmation of Your Service Order from VendorsCity</strong><br>                   
                         <strong> Dear </strong> : '.$user_name.'<br><br>
                     </p>
                    
                     <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin:0;">
                            Thank you for choosing VendorsCity for your service needs! We are pleased to confirm your recent order and appreciate your trust in our platform.
                     </p>
             ...
             <div style="background:#EDEDED;padding: 20px 7%;font-size: 14px;text-align: left;">
                 ...
                 <div style="background:#EDEDED;text-align: left;display: inline-block;margin-bottom: 10px;">
                     ...
                     <p style="margin:0">
                         ...
                         <strong>Order No :</strong> '.$order_number.'<br><br>
 
                         <strong>Date of Order :</strong> '.date('d-m-Y').'<br><br>';

                         
                         foreach($order_item_data as $arrRowDeailtss ) {
                            $message_bodyy .='<strong>Service:</strong> '.$arrRowDeailtss->service_name.'<br><br>';
                         }

                         $message_bodyy .='

                         <strong> Total Amount:</strong> '.$orderdata->order_currency.' '.number_format($orderdata->order_total,2).'<br><br><br>

                         </p>

                         <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin:0;">
                         Our team is now processing your order, and you will receive further instructions or updates shortly.
                     </p>
                     
                         <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 30px;">
                         Should you have any questions or require assistance regarding your order, please feel free to contact us at hello@vendorscity.com or call us at 056 VENDORS (056 836 3677). Our dedicated customer support team is here to assist you.
                     </p>
                     </p>
                     
                         <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 30px;">
                         We value your business and look forward to providing you with exceptional service.
                     </p>
                     <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 30px;">
            ...
            $subject = "Confirmation of Your Service Order from VendorsCity";
            $refer_id = $userdata['refer_id'];
