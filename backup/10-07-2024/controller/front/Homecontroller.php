...
//echo "<pre>";print_r($data);echo "</pre>";exit;
    ...
    public function subservices($service_url=''){
        ...
        $data['subservice_data'] = Subservice::where('serviceid',$data['service_data']->id)->orderBy('set_order')->get();
                ...
                <body>
                    <div class="wrapper">
                        ...
                        <div class="email_wrapper">
                         ...
                         <p><a class="btnlink" href="'.url("admin/vendors").'">View Application</a></p>
                        ...
                        <div class="email_footer">
                            ...
                            <div class="email_footer_div">
                                ...
                                <a href="'.url("/contact").'">Contact Us</a>
                                    ...
                                    <p>This message was mailed to '.$_POST['email'].' as part of you account registered with us on VendorsCity</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="email_footer">
                        ...
                        <div class="email_footer_div">
                            ...
                            <div class="footer_right">
                                ...
                                <p>This message was mailed to '.$data['email'].' as part of you account registered with us on VendorsCity</p>
                            </div>
                        </div>
                    </div>
                </div>
