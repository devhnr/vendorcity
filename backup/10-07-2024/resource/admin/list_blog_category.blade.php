    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                @if (in_array('25', $edit_perm))
                    <div class="col-auto">



                        <a class="btn btn-primary me-1" href="{{ route('blog_category.create') }}">
            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_blog_category') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('25', $edit_perm))
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('blog_category.edit', $data->id) }}"><i
