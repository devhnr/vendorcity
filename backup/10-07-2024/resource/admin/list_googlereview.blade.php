        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('1', $edit_perm))
                    <div class="col-auto">
                        <a class="btn btn-primary me-1" href="{{ route('google_review.create') }}">
                            <i class="fas fa-plus"></i> Add Google Review
                        </a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_google_review') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('1', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('google_review.edit', $data->id) }}"><i
