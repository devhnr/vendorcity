            ...
            <div class="col-xl-12">
                <div class="position-relative mb30-lg">
                    ...
                    @if (!empty($package_data) && isset($package_data[0]))
                        <div id="centerButton">
                            <a id="gets_button"
                                href="{{ route('enquiry', ['id' => 0, 'service_id' => $package_data[0]->service_id]) }}"
    ...
    <section class="pt30 pb90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    {{-- <h4>Description</h4> --}}
                    <p class="text mb30">{!! html_entity_decode($subservices_new->top_description) !!}</p>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="listing-style1">
                                    ...
                                    <div class="list-content">
                                        ...
                                        <div class="list-meta justify-content-between align-items-center mt15">
                                            ...
                                            <div class="budget" style="background-color: #0040E6;text-align: center;">
                                                @if (in_array('0', explode(',', $subservice->is_bookable)))
                                                    <a class="ud-btn btn-thm add-joining addtocart-btn_{{ $package_data_new->id }}"
                                                        ...
                                                        @if ($package_data_new->discount_type != '2')
                                                            <span class="fz18"
                                                                style="display: flex;">{{ $disc_price }} <span
                                                                    style="font-size: 12px"> AED &nbsp;</span>
                                                                <del class="fz15">{{ $package_data_new->price }}
                                                                </del> <span style="font-size: 12px"> AED
                                                                    &nbsp;</span>
                                                                @if ($package_data_new->discount != '')
                                                        ...
                                                        @else
                                                            <span class="fz18" style="display: flex;">
    ...
    <section class="pt30 pb90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    {{-- <h4>Description</h4> --}}
                    <p class="text mb30">{!! html_entity_decode($subservices_new->description) !!}</p>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h4 class="mb-4 font-weight-bold">
                                            {{ $package_attribut->title_addmore }}</h4>
                                    </div>
                                    <div class="col-12">{{ $package_attribut->description_addmore }}</div>
                                </div>
                            </div>
                        </div>
