...
<section class="our-about bgc-thm2 container pb0 pt0 mb30 mt50 vendor_banner_sec mrgb0">
    <div class="container">
            ...
            <div class="col-xl-12">
                <div class="position-relative mb30-lg mrgb0">
                    <div class="about-img wow fadeInRight mb-3" data-wow-delay="300ms">
                        @isset($banner_subservices->banner_image)
                            <img class="bdrs16"
                    ...
                    <div id="bannerBottom">
                        <p>Get <strong>5 Free Quotes</strong> from our <strong>Trusted Vendors</strong> @if($package_count > 0)or <strong>Choose a Package Below</strong> @endif</p>
                    </div>
...
<section class="pb90 pb30-md pt10 ptm0">
    <div class="container">
        ...
        @php
            ...
            $services = DB::table('subservices')->where('id', '!=', $banner_subservices->id)->where('serviceid', $banner_subservices->serviceid)->get();
            // echo '<pre>';
            // print_r($services);
            // echo '</pre>';
            // exit();
                    ...
                    @if ($index % 2 == 1)
                        ...
                        <div class="col-12 mb-5 col-md-6 pl-md-0 stack-top stack-adjust--left mrgb0">
                            <div class="placeholder rect bg-primary rounded b-lazy b-loaded"
                                style="background: url('{{ asset('public/upload/subservice/subservice_attr/large/' . $package_attribut->image) }}')">
                            </div>
                        </div>
                    @else
    ...
    <div class="container">
        <div class="row align-items-md-center">
            <div class="col-sm-12 col-xl-4 text-center">
                                ...
                                <h3 style="margin-top: 15px;">GET HIGH QUALITY LEADS</h3>
                                <p style="padding: 0 32px;">Unlock access to a multitude of service requests in your chosen city! </p>
                            </div>
                            <div class="col-sm-12 col-xl-4 text-center">
                                <img src="{{ asset('public/site/images/Receive_free_quotes.png') }}" alt="">
                                <h3 style="margin-top: 15px;">EXPAND YOUR MARKET REACH</h3>
                                <p style="padding: 0 32px;">Enhance your visibility and expand your customer base without extensive marketing
                                    efforts.</p>
                            </div>
                            <div class="col-sm-12 col-xl-4 text-center">
                                <img src="{{ asset('public/site/images/Sit_back_and_relax.png') }}" alt="">
                                <h3 style="margin-top: 15px;">FLEXIBLE ENGAGEMENT</h3>
                                <p style="padding: 0 32px;">Choose how you engage with leads, whether by providing instant quotes or customized
                                    proposals</p>
                            </div>
        </div>
    </div>
...
<div class="container googlereview">
    <div class="row align-items-md-center">
