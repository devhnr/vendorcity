        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 col-xl-6 mb30-md home_slider_padding">
                <div class="home11-hero-content">
                    ...
                    <p class="text animate-up-3">Effortlessly book trusted home services and reclaim your time in just a few clicks!</p>
                    <p class="text animate-up-3"><span class="fa-regular fa-user custom_icon"> </span> 15,000+ Customers |
                    ...
                    <div class="col-3">
                        <div class="funfact_one funfact_one_borderleft mb40">
                            <div class="details">
                                ...
                                <p class="mb-0" style="padding-left: 8px">Cities</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="funfact_one funfact_one_borderleft mb40" style="padding-left: 8px">
                            <div class="details">
                                ...
                                <p class="mb-0" style="padding-left: 13px">Vendors</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="container">
                    <div class="row align-items-center wow fadeInUp" data-wow-delay="00ms">
                        ...
                        <div class="col-5 col-lg-3">
                            <div class="text-start text-lg-end mb-4 mb-lg-2 mrg0">
