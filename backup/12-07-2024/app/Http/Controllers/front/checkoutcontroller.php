     ...
     <div class="email_wrapper">
                       ...
                       <div class="main">
                            <div class="row main_row">
                                ...
                                <div class="col-lg-2 custom_col_2">
                                    <h5>Service</h5>
                                </div>
                                <div class="col-lg-8 custom_col_8">';

                                if(!empty($order_item_package_data)){
                                    foreach($order_item_package_data as $package_data){
                                        $message_bodyy .='<p>'.$package_data->package_item_name.' * '.$package_data->package_quantity.'</p>';
                                    }

                                }else{
                                    $message_bodyy .='<p>'.$service_mail.'</p>';
                                }
                       ...
                       <div class="main">
                            <div class="row main_row">
                                ...
                                <div class="col-lg-2 custom_col_2_payment">
                                    <h5>Service Charges</h5>
                                </div>
                                <div class="col-lg-8 custom_col_8_payment">
                                    <p>AED '.$orderdata->sub_total.'</p>
                                </div>
                             </div>
