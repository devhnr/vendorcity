        ...
        //    echo"test-ok";exit;
            ...
            <body>
                <div class="wrapper">
                    ...
                    <ul><li style= "list-style-type: disc";> Service Requested : '.\Helper::servicename($request->service_id).'</li></ul>                        
                    <ul><li style= "list-style-type: disc";> Customer Name : '.$user_name.'</li></ul>                        
                    <ul><li style= "list-style-type: disc";> Request Date : '.$Date.'</li></ul>                        
                    <p><a class="btnlink" href="'.route("vendorinquiry.index").'">View Request</a></p>

                    <p><strong>What You Need to Do:</strong></p>
                    <ul><li style= "list-style-type: disc";> Log in to your : <a href="'.route("vendorinquiry.index").'">Vendor Portal</a></li></ul>
                    <ul><li style= "list-style-type: disc";> View the full request details and customer information.</li></ul>
           ...
           //  echo $vendor_data->email; 
            // echo $html;
            $subject = " New Quote Request for  " . \Helper::servicename($request->service_id) . "-Action Required";
...
<body>
    <div class="wrapper">
        ...
        <div class="email_wrapper">
            ...
            <ul><li style= "list-style-type: disc";>Review the quotes you receive.</li></ul>
            <ul><li  style= "list-style-type: disc";>Check out the vendor ratings and reviews to make an informed decision.</li></ul>
            <ul><li  style= "list-style-type: disc";>Select the vendor that best suits your requirements.</li></ul>  
        ...
        <div class="email_footer">
            ...
            <div class="email_footer_div">
                ...
                <div class="footer_right">
                    ...
                    <p>This message was mailed to '.$user_email.' as part of you account registered with us on VendorsCity</p>
                </div>
            </div>
        </div>
    </div>
