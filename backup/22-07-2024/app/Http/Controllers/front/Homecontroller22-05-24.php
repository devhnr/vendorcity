...
class Homecontroller extends Controller
{
    ...
    public function blog(){
        ...
        $pagination =  $query->paginate(1)->withQueryString();
                                ...
                                <td>
                                    <table style="border-top:3px solid #333;" bgcolor="#f7f7f7" width="100%" border="0" cellspacing="0" cellpadding="5">   
                                        <tr>
                                            <td width="50%">        
                                                <table width="100%" border="0" cellspacing="0" cellpadding="5">   
                                                    <tr><td>Thank you For Become A Vendor Registration.</td><td></td></tr>                                                   
                                                    <tr><td>Our team will get back to you shortly.</td><td></td></tr>                                                   
                                                    <tr><td>Thanks & Regards.</td><td></td></tr>                                                   
                                                    <tr><td>Team Vendorscity.</td><td></td></tr>                                                   
                                                </table>
                                            </td>   
                                        </tr>   
                                    </table>
