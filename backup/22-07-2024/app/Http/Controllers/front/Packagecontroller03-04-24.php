...
class Packagecontroller extends Controller
{
    ...
    //    echo "<pre>";print_r($vendor_id_array);echo "</pre>";exit;
        ...
        //    echo"test-ok";exit;
            ...
            // echo "<pre>";print_r($form_fields_data);echo "</pre>";exit;
             
            if($vendor_data && $vendor_data->is_active == 0){         
               
               $field_array = array();
               foreach ($form_fields_data as $values) {
                                               ...
                                               if (!empty($field_array)) {
                                                ...
                                                ->toArray();
                                                    ...
                                                    if ($form_field_data['value'] != '') {
                                                        $html .= '<tr>
                                                                   <th>'. $form_field_data['name'] .'</th>  ';

                                                                   if(is_numeric($form_field_data['value']) && $form_field_data['id'] != 30){
