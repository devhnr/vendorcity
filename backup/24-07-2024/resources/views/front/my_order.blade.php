                        ...
                        <div class="purchases_top_part">
                            ...
                            <div class="col-md-3">
                                <div class="track_order">
                                    ...
                                    <a href="{{ url('order-detail') }}">Detail</a>
                                </div>
                            </div>
                            </div>
                        </div>
                                    ...
                                    <div class="puchases_item_inner">
                                        ...
                                        @endphp   </p>
                                                    ...
                                                    @php
                                                        ...
                                                        $delivered_date = date_create($orders->created_at); 
                                                        $current_date = date_create(date("Y-m-d")); 
                                                        $diff=date_diff($delivered_date,$current_date);
                                                    @endphp

                                                    @if($orders->order_status == 'P' && $diff->format("%a") <= 7 && $item->is_return == 0)
                                                        <p><a href="{{ route('cancelpackage', ['id' => $item->id]) }}" style=" color: #0a58ca;">Cancel Package</a></p>

                                                    @endif

                                                    @if($item->is_return == 1)

                                                        <p>Package Canceled</p>
