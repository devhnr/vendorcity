                    ...
                    <div class="col-lg-4">
                        <div class="shop-sidebar ms-lg-auto">
                            <div class="order_sidebar_widget default-box-shadow1">
                                ...
                                <p class="text bdrb1 pb10">Subtotal <span class="float-end">AED
                                        {{ $subtotal }}</span></p>
                                ...
                                @if ($userId !== null)
                                    <div class="d-grid mt40">
                                        <a class="ud-btn btn-thm" href="{{ url('/checkout') }}">Proceed to Checkout<i
                                                class="fal fa-arrow-right-long"></i></a>
                                    </div>
                                @else
                                    <div class="d-grid mt40">
                                        <a class="ud-btn btn-thm" href="{{ route('Sign-in') }}">Proceed to Checkout<i
                                                class="fal fa-arrow-right-long"></i></a>
                                    </div>
                                @endif
                            </div>
