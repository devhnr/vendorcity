            ...
            <div class="row align-items-center">
                ...
                @if (in_array('2', $edit_perm))
                    <div class="col-auto">
                        ...
                        {{-- <a class="btn btn-primary me-1" href="{{ route('upload_state') }}">
                            <i class="fas fa-plus"></i> Bulk State Add
                        </a> --}}

                        <a class="btn btn-primary me-1" href="{{ route('state.create') }}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_state') }}" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        @foreach ($all_state as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->country_id != '')
                                                        {!! Helper::countryname(strval($data->country_id)) !!}
                                                    @endif
                                                </td>
                                                <td>
                                                    {{ $data->state }}
                                                ...
                                                @if (in_array('2', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('state.edit', $data->id) }}"><i
