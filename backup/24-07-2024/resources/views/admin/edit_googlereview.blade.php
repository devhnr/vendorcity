            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('google_review.update', $googlereview->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    {{--<input id="labelaa" name="labelaa" type="text" class="form-control"

                                        placeholder="Enter Label" value="{{ $googlereview->label }}" />--}}
                                   ...
                                   <!--  <input id="label" name="label" type="text" class="form-control"
                                        ...
                                        <select id="label" name="label" class="form-control">
                                            ...
                                            <option value="1" {{ $googlereview->label == 1 ? 'selected' : '' }}>1</option>
                                            <option value="2" {{ $googlereview->label == 2 ? 'selected' : '' }}>2</option>
                                            <option value="3" {{ $googlereview->label == 3 ? 'selected' : '' }}>3</option>
                                            <option value="4" {{ $googlereview->label == 4 ? 'selected' : '' }}>4</option>
                                            <option value="5" {{ $googlereview->label == 5 ? 'selected' : '' }}>5</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control"
                                        ...
                                        placeholder="Enter Description" value="">{{ $googlereview->description }}</textarea>
