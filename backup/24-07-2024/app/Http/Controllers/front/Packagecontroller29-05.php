            ...
            <body>
                <div class="wrapper">
                    ...
                    <div class="email_wrapper">
                        ...
                        <p>Service Name: '.\Helper::servicename($request->service_id).'</p>
                        <p>Customer Name: '.$user_name.'</p>
                        <p>Date: '.$Date.'</p>
                        <p><a class="btnlink" href="'.route("vendorinquiry.index").'">View Request</a></p>
                        <p>Submit your quote within 24 hours. Please ensure your quote is competitive and detailed to increase your chances of securing the job. If you have any questions or need assistance, feel free to reach out to us at hello@vendorscity.com.</p>
...
<div style="max-width:630px;margin: 0 auto;border: thin solid #f3f0f0;">
    ...
    <header style="text-align:center;"><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
        ...
        <a href="{{ config("app.url") }}"><img style="max-width:150px;display: inline-block;" src="'.asset("public/site/images/VC-FULL-COLOR.png").'"></a>           </header>

    

    <div style="background:#EDEDED;padding: 20px 7%;font-size: 14px;text-align: left;">

        <div style="background:#EDEDED;text-align: left;display: inline-block;margin-bottom: 10px;">

        <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;line-height: 30px;color:#fff;margin:0; color:black">

                <strong>  Get Ready for Personalized Quotes from VendorsCity!</strong><br>                   
                <strong> Dear </strong> : '.$user_name.'<br><br>
            </p>
           
            <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin:0;">
            Thank you for submitting your request for up to 5 free quotes on VendorsCity! We appreciate your interest in our services.
            </p>
             <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 25px;">
             Our team is currently processing your request and gathering quotes from our trusted vendors. You can expect the vendors to get in touch with you directly within the next 1-2 Business Days with their offers tailored to your needs.
             </p>
             <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 25px;">
             Should you have any questions or need further assistance, please feel free to contact us at hello@vendorscity.com or call us at 056 VENDORS (056 836 3677). Our team is here to help and ensure you have a seamless experience with VendorsCity.
             </p> 
             <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 25px;">
             Thank you for choosing VendorsCity. We look forward to connecting you with the perfect vendors for your service needs.
            </p>

             
                        <p style="font-size: 17px;letter-spacing: 0.5px;text-align:center;color:black;margin-top: 30px;">
                     
                     <img style="max-width:150px;display: inline-block;" src="'.asset("public/site/images/VC-FULL-COLOR.png").'">
                     </p>
        </div>
   ...
   $subject = "Get Ready for Personalized Quotes from VendorsCity!";
